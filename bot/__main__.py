...
from bot import bot, app, IMAGE_URL, dispatcher, updater, botStartTime, IGNORE_PENDING_REQUESTS, IS_VPS, PORT, alive, web, OWNER_ID, AUTHORIZED_CHATS, LOGGER, Interval, nox, rss_session, a2c
...
def start(update, context):
    buttons = ButtonMaker()
    buttons.buildbutton("Channel", "https://t.me/tntoonbot")
    buttons.buildbutton("chat Group", "https://t.me/tntoonbotchat")
...
'''
        ...
        sendMarkup('Sorry, You are not authorized user', context.bot, update, reply_markup)
